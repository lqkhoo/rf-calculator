...
if __name__ == '__main__':
    ...
    TsvReader.read_item_names(item_ids, items, '../tsv/rf5/map_itemid_to_english_name.tsv', '../tsv/rf5/map_itemid_to_japanese_name_shiftjis.tsv')
    TsvReader.read_item_images(item_ids, items, '../tsv/rf5/map_itemid_to_image.tsv')
    TsvReader.read_item_stats('../tsv/rf5/map_itemid_to_strengthening_data.tsv', items)

    # Handle base item subset
    TsvReader.read_item_names(item_ids, base_items, '../tsv/rf5/map_itemid_to_english_name.tsv', '../tsv/rf5/map_itemid_to_japanese_name_shiftjis.tsv')
    TsvReader.read_item_images(item_ids, base_items, '../tsv/rf5/map_itemid_to_image.tsv')
    ...
    TsvReader.read_category_names(category_ids, categories, '../tsv/rf5/map_categoryid_to_english_name.tsv', '../tsv/rf5/map_categoryid_to_japanese_name_shiftjis.tsv')
    TsvReader.read_category_images(category_ids, categories, '../tsv/rf5/map_categoryid_to_image.tsv')

    TsvReader.read_character_names(character_ids, characters, '../tsv/rf5/map_characterid_to_english_name.tsv', '../tsv/rf5/map_characterid_to_japanese_name_shiftjis.tsv')
    TsvReader.read_character_images(character_ids, characters, '../tsv/rf5/map_characterid_to_icon.tsv', '../tsv/rf5/map_characterid_to_sprites.tsv')
    TsvReader.read_character_stats('../tsv/rf5/map_characterid_to_stats.tsv', characters)

    # Full item stats
    TsvReader.read_item_rarity(items, '../tsv/rf5/map_itemid_to_rarity.tsv')
    TsvReader.read_item_rarity_stat_type(items, '../tsv/rf5/map_itemid_to_rarity_stat_type.tsv')
    TsvReader.read_item_weapon_element(items, '../tsv/rf5/map_itemid_to_weapon_element.tsv')
    TsvReader.read_item_crystal_element(items, '../tsv/rf5/map_itemid_to_crystal_element.tsv')
    TsvReader.read_item_magic(items, '../tsv/rf5/map_itemid_to_magicid.tsv')

    # Recipes
    TsvReader.read_recipes(recipes, '../tsv/rf5/map_itemid_to_recipe.tsv')

    # Magics
    TsvReader.read_magics(magics, '../tsv/rf5/map_magicid_to_name_shiftjis.tsv')

    # Special effects (boots + acce)
    TsvReader.read_effects(effects, '../tsv/rf5/map_itemid_to_effect_japanese_shiftjis.tsv', '../tsv/rf5/map_itemid_to_effect_english.tsv')
    ...
    write_rawdata(path_output='../ts/rf5-rawdata.ts', variablename='_RAWDATA')
    write_data_html(path_input='../rf5-data-base.html', path_output='../rf5-data.html')
