...
class VectorCharFinalStats extends StatVector {
    ...
    protected override _compute_stat_chargespeed = (): number => {
        return this.Character().EquipmentStats().stat_chargespeed();
    }
    protected override _compute_stat_attacklength = (): number => {
        return this.Character().EquipmentStats().stat_attacklength();
    }
