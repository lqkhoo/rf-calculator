...
abstract class StatVector implements IStatVector {
    ...
    constructor(data: IData,
        ...
        this.name_jp = ko.pureComputed(self._compute_name_jp).extend({ deferred: true });
        this.image_uri = ko.pureComputed(self._compute_image_uri).extend({ deferred: true });
    ...
    public FinalizeVectorOverride = (): void => {
        ...
        this.StatNameMap[StatVector.KEY_name_jp] = this.name_jp;
        this.StatNameMap[StatVector.KEY_image_uri] = this.image_uri;
        this.StatNameMap[StatVector.KEY_level] = this.level;
        this.StatNameMap[StatVector.KEY_rarity] = this.rarity;
        this.StatNameMap[StatVector.KEY_stat_ATK] = this.stat_ATK;
        this.StatNameMap[StatVector.KEY_stat_DEF] = this.stat_DEF;
        this.StatNameMap[StatVector.KEY_stat_MAT] = this.stat_MAT;
        this.StatNameMap[StatVector.KEY_stat_MDF] = this.stat_MDF;
        this.StatNameMap[StatVector.KEY_stat_STR] = this.stat_STR;
        this.StatNameMap[StatVector.KEY_stat_INT] = this.stat_INT;
        this.StatNameMap[StatVector.KEY_stat_VIT] = this.stat_VIT;
        this.StatNameMap[StatVector.KEY_stat_atk_CRT] = this.stat_atk_CRT;
        this.StatNameMap[StatVector.KEY_stat_atk_KNO] = this.stat_atk_KNO;
        this.StatNameMap[StatVector.KEY_stat_atk_STN] = this.stat_atk_STN;
        this.StatNameMap[StatVector.KEY_stat_atk_DIZ] = this.stat_atk_DIZ;
        this.StatNameMap[StatVector.KEY_stat_atk_PSN] = this.stat_atk_PSN;
        this.StatNameMap[StatVector.KEY_stat_atk_SEA] = this.stat_atk_SEA;
        this.StatNameMap[StatVector.KEY_stat_atk_PAR] = this.stat_atk_PAR;
        this.StatNameMap[StatVector.KEY_stat_atk_SLP] = this.stat_atk_SLP;
        this.StatNameMap[StatVector.KEY_stat_atk_FTG] = this.stat_atk_FTG;
        this.StatNameMap[StatVector.KEY_stat_atk_SCK] = this.stat_atk_SCK;
        this.StatNameMap[StatVector.KEY_stat_atk_FNT] = this.stat_atk_FNT;
        this.StatNameMap[StatVector.KEY_stat_atk_DRN] = this.stat_atk_DRN;
        this.StatNameMap[StatVector.KEY_stat_def_ele_FIRE] = this.stat_def_ele_FIRE;
        this.StatNameMap[StatVector.KEY_stat_def_ele_WATER] = this.stat_def_ele_WATER;
        this.StatNameMap[StatVector.KEY_stat_def_ele_EARTH] = this.stat_def_ele_EARTH;
        this.StatNameMap[StatVector.KEY_stat_def_ele_WIND] = this.stat_def_ele_WIND;
        this.StatNameMap[StatVector.KEY_stat_def_ele_LIGHT] = this.stat_def_ele_LIGHT;
        this.StatNameMap[StatVector.KEY_stat_def_ele_DARK] = this.stat_def_ele_DARK;
        this.StatNameMap[StatVector.KEY_stat_def_ele_LOVE] = this.stat_def_ele_LOVE;
        this.StatNameMap[StatVector.KEY_stat_def_ele_VOID] = this.stat_def_ele_VOID;
        this.StatNameMap[StatVector.KEY_stat_def_CRT] = this.stat_def_CRT;
        this.StatNameMap[StatVector.KEY_stat_def_KNO] = this.stat_def_KNO;
        this.StatNameMap[StatVector.KEY_stat_def_STN] = this.stat_def_STN;
        this.StatNameMap[StatVector.KEY_stat_def_DIZ] = this.stat_def_DIZ;
        this.StatNameMap[StatVector.KEY_stat_def_PSN] = this.stat_def_PSN;
        this.StatNameMap[StatVector.KEY_stat_def_SEA] = this.stat_def_SEA;
        this.StatNameMap[StatVector.KEY_stat_def_PAR] = this.stat_def_PAR;
        this.StatNameMap[StatVector.KEY_stat_def_SLP] = this.stat_def_SLP;
        this.StatNameMap[StatVector.KEY_stat_def_FTG] = this.stat_def_FTG;
        this.StatNameMap[StatVector.KEY_stat_def_SCK] = this.stat_def_SCK;
        this.StatNameMap[StatVector.KEY_stat_def_FNT] = this.stat_def_FNT;
        this.StatNameMap[StatVector.KEY_stat_def_DRN] = this.stat_def_DRN;
        this.StatNameMap[StatVector.KEY_stat_chargespeed] = this.stat_chargespeed;
        this.StatNameMap[StatVector.KEY_stat_attacklength] = this.stat_attacklength;
    }
    ...
    protected _compute_name_en = this._compute_string_helper(StatVector.KEY_name_en, "None");
    protected _compute_name_jp = this._compute_string_helper(StatVector.KEY_name_jp, "\u306a\u3057");
    protected _compute_image_uri = this._compute_string_helper(StatVector.KEY_image_uri, "icon/Empty.png");
    // protected _compute_level = this._compute_number_helper(RF5StatVector.KEY_level, 1);
    protected _compute_level = (): number => { return 0; }
    protected _compute_rarity = this._compute_number_helper(StatVector.KEY_rarity, 0);
    protected _compute_stat_ATK = this._compute_number_helper(StatVector.KEY_stat_ATK, 0);
    protected _compute_stat_DEF = this._compute_number_helper(StatVector.KEY_stat_DEF, 0);
    protected _compute_stat_MAT = this._compute_number_helper(StatVector.KEY_stat_MAT, 0);
    protected _compute_stat_MDF = this._compute_number_helper(StatVector.KEY_stat_MDF, 0);
    protected _compute_stat_STR = this._compute_number_helper(StatVector.KEY_stat_STR, 0);
    protected _compute_stat_INT = this._compute_number_helper(StatVector.KEY_stat_INT, 0);
    protected _compute_stat_VIT = this._compute_number_helper(StatVector.KEY_stat_VIT, 0);
    protected _compute_stat_atk_CRT = this._compute_number_helper(StatVector.KEY_stat_atk_CRT, 0, true);
    protected _compute_stat_atk_KNO = this._compute_number_helper(StatVector.KEY_stat_atk_KNO, 0, true);
    protected _compute_stat_atk_STN = this._compute_number_helper(StatVector.KEY_stat_atk_STN, 0, true);
    protected _compute_stat_atk_DIZ = this._compute_number_helper(StatVector.KEY_stat_atk_DIZ, 0, true);
    protected _compute_stat_atk_PSN = this._compute_number_helper(StatVector.KEY_stat_atk_PSN, 0, true);
    protected _compute_stat_atk_SEA = this._compute_number_helper(StatVector.KEY_stat_atk_SEA, 0, true);
    protected _compute_stat_atk_PAR = this._compute_number_helper(StatVector.KEY_stat_atk_PAR, 0, true);
    protected _compute_stat_atk_SLP = this._compute_number_helper(StatVector.KEY_stat_atk_SLP, 0, true);
    protected _compute_stat_atk_FTG = this._compute_number_helper(StatVector.KEY_stat_atk_FTG, 0, true);
    protected _compute_stat_atk_SCK = this._compute_number_helper(StatVector.KEY_stat_atk_SCK, 0, true);
    protected _compute_stat_atk_FNT = this._compute_number_helper(StatVector.KEY_stat_atk_FNT, 0, true);
    protected _compute_stat_atk_DRN = this._compute_number_helper(StatVector.KEY_stat_atk_DRN, 0, true);
    protected _compute_def_ele_FIRE = this._compute_number_helper(StatVector.KEY_stat_def_ele_FIRE, 0, true);
    protected _compute_def_ele_WATER = this._compute_number_helper(StatVector.KEY_stat_def_ele_WATER, 0, true);
    protected _compute_def_ele_EARTH = this._compute_number_helper(StatVector.KEY_stat_def_ele_EARTH, 0, true);
    protected _compute_def_ele_WIND = this._compute_number_helper(StatVector.KEY_stat_def_ele_WIND, 0, true);
    protected _compute_def_ele_LIGHT = this._compute_number_helper(StatVector.KEY_stat_def_ele_LIGHT, 0, true);
    protected _compute_def_ele_DARK = this._compute_number_helper(StatVector.KEY_stat_def_ele_DARK, 0, true);
    protected _compute_def_ele_LOVE = this._compute_number_helper(StatVector.KEY_stat_def_ele_LOVE, 0, true);
    protected _compute_def_ele_VOID = this._compute_number_helper(StatVector.KEY_stat_def_ele_VOID, 0, true);
    protected _compute_def_CRT = this._compute_number_helper(StatVector.KEY_stat_def_CRT, 0, true);
    protected _compute_def_KNO = this._compute_number_helper(StatVector.KEY_stat_def_KNO, 0, true);
    protected _compute_def_STN = this._compute_number_helper(StatVector.KEY_stat_def_STN, 0, true);
    protected _compute_def_DIZ = this._compute_number_helper(StatVector.KEY_stat_def_DIZ, 0, true);
    protected _compute_def_PSN = this._compute_number_helper(StatVector.KEY_stat_def_PSN, 0, true);
    protected _compute_def_SEA = this._compute_number_helper(StatVector.KEY_stat_def_SEA, 0, true);
    protected _compute_def_PAR = this._compute_number_helper(StatVector.KEY_stat_def_PAR, 0, true);
    protected _compute_def_SLP = this._compute_number_helper(StatVector.KEY_stat_def_SLP, 0, true);
    protected _compute_def_FTG = this._compute_number_helper(StatVector.KEY_stat_def_FTG, 0, true);
    protected _compute_def_SCK = this._compute_number_helper(StatVector.KEY_stat_def_SCK, 0, true);
    protected _compute_def_FNT = this._compute_number_helper(StatVector.KEY_stat_def_FNT, 0, true);
    protected _compute_def_DRN = this._compute_number_helper(StatVector.KEY_stat_def_DRN, 0, true);
    protected _compute_stat_chargespeed = this._compute_number_helper(StatVector.KEY_stat_chargespeed, 0);
    protected _compute_stat_attacklength = this._compute_number_helper(StatVector.KEY_stat_attacklength, 0);
