...
class RF5StatVector implements IStatVector {
    ...
    readonly UseEquipmentStats: ko.Observable<boolean>;
    ...
    constructor(id: number, useEquipmentStats: boolean=false) {
        ...
        this.UseEquipmentStats = ko.observable(useEquipmentStats);

        this.Context = ko.pureComputed(function() {
            if(useEquipmentStats) {
                return (Data.BaseItems as any)[self.id()] || (Data.BaseItems as any)["0"];
            } else {
                return (Data.Items as any)[self.id()] || (Data.Items as any)["0"];
            }
        });

        // Override these as necessary. These are default / unmodified / last-resort values.

        this.Multiplier = ko.pureComputed(function() { return 1; });
        
        this.name_en = ko.pureComputed(function() {
            let name_en: string = "None";
            if((self.Context() as any).name_en !== undefined) {
        ...
        this.name_jp = ko.pureComputed(function() {
            ...
            if((self.Context() as any).name_jp !== undefined) {
        ...
        this.image_uri = ko.pureComputed(function() {
            ...
            if((self.Context() as any).image_uri !== undefined) {
        ...
        this.level = ko.pureComputed(function() {
            let level: number = 10;
            if((self.Context() as any).level !== undefined) {
        ...
        this.rarity = ko.pureComputed(function() {
            let rarity: number = 0;
            if((self.Context() as any).rarity !== undefined) {
